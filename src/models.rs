...
pub struct NodeInfoResponse {
    ...
    pub top_hash: Option<HashString<CryptoNoteHash>>,
    pub tx_count: u64,
...
pub struct NodeConnection {
    ...
    pub avg_upload: u64,
    pub connection_id: HashString<Vec<u8>>,
...
pub struct PoolTransaction {
    ...
    pub last_failed_id_hash: HashString<CryptoNoteHash>,
    pub last_relayed_time: u64,
    pub max_used_block_height: u64,
    pub max_used_block_id_hash: HashString<CryptoNoteHash>,
